...
CREATE UNIQUE INDEX ON psbts (unsigned_transaction_id, user_id);
...
COMMENT ON COLUMN psbts.user_id IS 'The user that signed the PSBT';
...
BEGIN
    ...
    INSERT INTO psbts (unsigned_transaction_id, psbt_base64, user_id)
